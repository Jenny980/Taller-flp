...
;;            registros con su respectiva llave, saber si un registro contiene lista de registros o si no contiene.                                ;;
;;                                                                                                                                                 ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Definicion
...
;; Constructor que permite definir un registro vacío
(define r-vacio
  (lambda ()
    '(r-vacio)))
...
;; Constructor que permite definir una lista de números vacia                              
(define lnumvacia
  (lambda ()
    '(lnumvacia)))

;; Constructor que permite definir una lista de números y los datos que contiene (numero, lista de numeros) 
(define lnumnovacia
  (lambda (num lst)
    (list 'lnumnovacia num lst)))

;; Constructor que permite definir una lista de simbolos vacía
(define lsymvacia
  (lambda ()
    '(lsymvacia)))

;; Constructor que permite definir una lista de simbolos y los datos que contiene (simbolo, lista de simbolos)
(define lsymnovacia
  (lambda (sym lst)
...
;;Nos permite consultar si es un registro vacío
(define r-vacio?
  (lambda (reg)
    (equal? (car reg) 'r-vacio)))

;;Nos permite consultar si un registro no es vacío
(define r-novacio?
  (lambda (exp)
...
;;Nos permite consultar si es una lista de números vacía
(define lnumvacia?
  (lambda (reg)
    (list? reg)))

;;Nos permite consultar si es una lista de números no vacia
(define lnumnovacia?
  (lambda (exp)
    (equal? (car exp) 'lnumnovacia)))

;;Nos permite consultar si es una lista de simbolos vacía
(define lsymvacia?
   (lambda (n)
    (null? n)))

;;Nos permite consultar si es una lista de simbolos no vacía
(define lsymnovacia?
   (lambda (exp)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;; Función que retorna el dato de acuerdo a una llave  ;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
